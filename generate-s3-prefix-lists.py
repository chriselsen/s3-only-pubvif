...
REGION_INFO = {
    ...
    'us-gov-east-1': ('xx', 'USA', 'AWS GovCloud (US-East)'),
    'us-gov-west-1': ('xx', 'USA', 'AWS GovCloud (US-West)'),
    ...
    'sa-west-1': ('xx', 'Chile', 'South America (Santiago)'),
